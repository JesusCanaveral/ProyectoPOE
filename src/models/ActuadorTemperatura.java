...
public class ActuadorTemperatura extends DispositivoIOT{
    ...
    public ActuadorTemperatura(String id, String ip, String estadoActividad, String nombre, String modelo, String versionFirmware, double umbralTemperaturaMinima, double umbralTemperaturaMaxima, float posicion, float tiempoRespuesta, String tipoActuador) {
